...
async function search() {
  ...
  results.value = []
  try {
    const url = roomCode.value
      ? `${apiBase}/schedule/get_empty_rooms_db?schedule_date=${queryDate.value}&room_code=${encodeURIComponent(roomCode.value)}`
      : `${apiBase}/schedule/get_schedule_all_empty_rooms/?schedule_date=${queryDate.value}`
